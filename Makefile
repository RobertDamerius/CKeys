...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
LIBS_WINDOWS      := -lstdc++ -lpthread -lfreetype -lglfw3 -lglad -lopengl32 -lgdi32 -lcomdlg32 -lportaudio -lrtmidi -lwinmm -lsetupapi -lole32
LIBS_LINUX        := -lstdc++ -lpthread -lfreetype -lglfw3 -lglad -lGL -lX11 -ldl -lportaudio -lrtmidi
CC_SYMBOLS         = 
